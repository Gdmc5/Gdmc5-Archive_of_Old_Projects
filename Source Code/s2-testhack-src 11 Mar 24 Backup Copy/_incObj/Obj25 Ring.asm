...
CollectRing_1P:
	...
	; -UNSPECIFIED Removed Revision 0 -GDMC5
	...
	; -UNSPECIFIED Added in a third Ring Extra Life Prize -GDMC5
	beq.s	+			; if it was clear before, branch
	cmpi.w	#300,(Ring_count).w	; does the player 1 have less than 300 rings?
	blo.s	JmpTo_PlaySound2	; if yes, play the ring sound
	bset	#3,(Extra_life_flags).w	; test and set the flag for the third extra life
;	beq.s	+			; if it was clear before, branch
	bne.s	JmpTo_PlaySound2	; if it was set before, play the ring sound
+
	; -UNSPECIFIED Max The Lives Counter To 99 -GDMC5
	cmpi.b	#99,(Life_count).w	; does the player 1 have more than 99 lives
	bhs.s	+	; if yes branch
...
; CollectRing_2P:
	...
	; -UNSPECIFIED Added in a third Ring Extra Life Prize -GDMC5
	beq.s	+			; if it was clear before, branch
	cmpi.w	#300,(Ring_count_2P).w		; does the player 2 have less than 300 rings?
	blo.s	JmpTo2_PlaySound2		; if yes, play the ring sound
	bset	#3,(Extra_life_flags_2P).w	; test and set the flag for the third extra life
;	beq.s	+			; if it was clear before, branch
	bne.s	JmpTo2_PlaySound2		; if it was set before, play the ring sound
+
	; -UNSPECIFIED Max The Lives Counter To 99 -GDMC5
	cmpi.b	#99,(Life_count_2P).w	; does the player 2 have more than 99 lives
	bhs.s	+	; if yes branch
...
; End of function CollectRing
	...
	; -UNSPECIFIED Moved the Ring Objects Animation script and the Sprite mappings into Obj25 Ring Asm File -GDMC5
; ===========================================================================
