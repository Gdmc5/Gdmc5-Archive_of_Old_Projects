local function build_rom(input_filename, output_filename, p2bin_arguments)
	local common = require "build_tools.lua.common"

	-- Obtain the paths to the native build tools for the current platform.
	local tools, platform_directory = common.find_tools("fdp2bin")
	...
	-- Assemble the ROM.
	local assemble_result = common.assemble_file(input_filename .. ".asm", output_filename .. ".bin", tools.as, p2bin_arguments, tools.fdp2bin and "" or "-a", false)
