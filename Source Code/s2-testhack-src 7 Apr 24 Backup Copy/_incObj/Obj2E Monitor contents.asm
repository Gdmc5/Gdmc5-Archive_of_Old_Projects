...
Obj2E_Types:	offsetTable
	; -UNSPECIFIED Added in Some Dummy Monitor Subtype code -GDMC5
		offsetTableEntry.w static_monitor	; 0 - Static
	...
	; -UNSPECIFIED Added in Some Dummy Monitor Subtype code -GDMC5
		offsetTableEntry.w static_monitor	; A - Broken
...
+
	...
	cmpi.w	#300,(a2)
	blo.s	+		; branch, if player has less than 300 rings
	bset	#3,(a4)		; set flag for third 1up
	beq.s	ChkPlayer_1up	; branch, if not yet set
...
; ===========================================================================
	...
	; -UNSPECIFIED Removed Revision 1 -GDMC5
