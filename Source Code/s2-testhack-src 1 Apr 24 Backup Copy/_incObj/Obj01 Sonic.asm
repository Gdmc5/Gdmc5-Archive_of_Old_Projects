...
+
	...
	; instead.
	; -BUGFIXES Always Have The Bug Fixed -GDMC5
	move.b	angle(a0),d1
	addi.b	#$20,d1
	andi.b	#$C0,d1
	bne.s	return_1A744
...
Sonic_CheckGoSuper:
	...
	; -UNSPECIFIED Made It Where You Can Turn Super With 7 or Higher Emeralds -GDMC5
	cmpi.b	#7,(Emerald_count).w	; does Sonic have 7 or higher emeralds?
	blt.s	return_1ABA4		; if not, branch
	cmpi.w	#50,(Ring_count).w	; does Sonic have at least 50 rings?
	blo.s	return_1ABA4		; if not, branch
	; -UNSPECIFIED Always Use Revision 2 -GDMC5
	; -BUGFIXES Always Have The Bug Fixed -GDMC5
...
CheckGameOver:
	...
	; -UNSPECIFIED Added in a Infinite Lives Mode -GDMC5
	cmpi.b	#100,(Life_count).w	; does the player 1 have infinite lives
	beq.s	Obj01_ResetLevel	; if yes branch
...
SonAni_Burned_ptr:		offsetTableEntry.w SonAni_Burned	; 22 ; $16
...
SuperSonicAniData: offsetTable
	...
	; -UNSPECIFIED Restored the burned death animation -GDMC5
	offsetTableEntry.w SonAni_Burned	; 22 ; $16
	...
	; -BUGFIXES Fixed a Bug That Crashes The Game In the Continue Screen. Credit Goes to DankRank For the Fix -GDMC5
