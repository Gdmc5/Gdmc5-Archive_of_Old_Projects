...
status =		$22 ; note: exact meaning depends on the object... for Sonic/Tails/Knuckles: bit 0: left-facing. bit 1: in-air. bit 2: spinning. bit 3: on-object. bit 4: roll-jumping. bit 5: pushing. bit 6: underwater.
routine =		$24
...
subtype =		$28
; ---------------------------------------------------------------------------
; conventions specific to Sonic/Tails/Knuckles (Obj01, Obj02, ObjE5, and ObjDB):
; note: $1F, $20, and $21 are unused and available
inertia =		$14 ; and $15 ; directionless representation of speed... not updated in the air
; -UNSPECIFIED Added in some Ported KIS2 Features for Knuckles -GDMC5
...
; -UNSPECIFIED Added Extra Zones -GDMC5
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
NumberOfZones = $2B
	else
NumberOfZones = $21
...
unknown_zone_1 zoneID			$01
secret_woods_zone zoneID		$02
...
; -UNSPECIFIED Added Extra Zones -GDMC5
; -UNSPECIFIED Added in a Full Death Egg Zone -GDMC5
death_egg_zone_2 zoneID		$11
unknown_zone_2 zoneID		$12
reserved_zone_1 zoneID		$13
reserved_zone_2 zoneID		$14
reserved_zone_3 zoneID		$15
reserved_zone_4 zoneID		$16
reserved_zone_5 zoneID		$17
reserved_zone_6 zoneID		$18
reserved_zone_7 zoneID		$19
reserved_zone_8 zoneID		$1A
reserved_zone_9 zoneID		$1B
reserved_zone_10 zoneID		$1C
reserved_zone_11 zoneID		$1D
reserved_zone_12 zoneID		$1E
reserved_zone_13 zoneID		$1F
reserved_zone_14 zoneID		$20
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
test_zone_1 zoneID		$21
test_zone_1_2 zoneID		$22
test_zone_2 zoneID		$23
test_zone_2_2 zoneID		$24
test_zone_3 zoneID		$25
test_zone_3_2 zoneID		$26
test_zone_4 zoneID		$27
test_zone_4_2 zoneID		$28
test_zone_5 zoneID		$29
test_zone_5_2 zoneID		$2A
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
dummy_zone zoneID		$2B
	else
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
dummy_zone zoneID		$21	
	endif
...
metropolis_zone_act_4 =		(metropolis_zone_2<<8)|$01 ; unused act
...
death_egg_zone_act_3 =		(death_egg_zone<<8)|$00
death_egg_zone_act_4 =		(death_egg_zone<<8)|$01
; Prototype zone and act IDs
unknown_zone_1_act_1 =		(unknown_zone_1<<8)|$00
unknown_zone_1_act_2 =		(unknown_zone_1<<8)|$01
secret_woods_zone_act_1 =		(secret_woods_zone<<8)|$00
secret_woods_zone_act_2 =		(secret_woods_zone<<8)|$01
...
cyber_city_zone_act_1 =	(cyber_city_zone<<8)|$00
cyber_city_zone_act_2 =	(cyber_city_zone<<8)|$01
; -UNSPECIFIED Added Extra Zones -GDMC5
; Extra Zone Slots
death_egg_zone_act_1 =		(death_egg_zone_2<<8)|$00
death_egg_zone_act_2 =		(death_egg_zone_2<<8)|$01
unknown_zone_2_act_1 =		(unknown_zone_2<<8)|$00
unknown_zone_2_act_2 =		(unknown_zone_2<<8)|$01
reserved_zone_1_act_1 =		(reserved_zone_1<<8)|$00
reserved_zone_1_act_2 =		(reserved_zone_1<<8)|$01
reserved_zone_2_act_1 =		(reserved_zone_2<<8)|$00
reserved_zone_2_act_2 =		(reserved_zone_2<<8)|$01
reserved_zone_3_act_1 =		(reserved_zone_3<<8)|$00
reserved_zone_3_act_2 =		(reserved_zone_3<<8)|$01
reserved_zone_4_act_1 =		(reserved_zone_4<<8)|$00
reserved_zone_4_act_2 =		(reserved_zone_4<<8)|$01
reserved_zone_5_act_1 =		(reserved_zone_5<<8)|$00
reserved_zone_5_act_2 =		(reserved_zone_5<<8)|$01
reserved_zone_6_act_1 =		(reserved_zone_6<<8)|$00
reserved_zone_6_act_2 =		(reserved_zone_6<<8)|$01
reserved_zone_7_act_1 =		(reserved_zone_7<<8)|$00
reserved_zone_7_act_2 =		(reserved_zone_7<<8)|$01
reserved_zone_8_act_1 =		(reserved_zone_8<<8)|$00
reserved_zone_8_act_2 =		(reserved_zone_8<<8)|$01
reserved_zone_9_act_1 =		(reserved_zone_9<<8)|$00
reserved_zone_9_act_2 =		(reserved_zone_9<<8)|$01
reserved_zone_10_act_1 =		(reserved_zone_10<<8)|$00
reserved_zone_10_act_2 =		(reserved_zone_10<<8)|$01
reserved_zone_11_act_1 =		(reserved_zone_11<<8)|$00
reserved_zone_11_act_2 =		(reserved_zone_11<<8)|$01
reserved_zone_12_act_1 =		(reserved_zone_12<<8)|$00
reserved_zone_12_act_2 =		(reserved_zone_12<<8)|$01
reserved_zone_13_act_1 =		(reserved_zone_13<<8)|$00
reserved_zone_13_act_2 =		(reserved_zone_13<<8)|$01
reserved_zone_14_act_1 =		(reserved_zone_14<<8)|$00
reserved_zone_14_act_2 =		(reserved_zone_14<<8)|$01
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
test_zone_1_act_1 =		(test_zone_1<<8)|$00
test_zone_1_act_2 =		(test_zone_1<<8)|$01
test_zone_1_act_3 =		(test_zone_1_2<<8)|$00
test_zone_1_act_4 =		(test_zone_1_2<<8)|$01
test_zone_2_act_1 =		(test_zone_2<<8)|$00
test_zone_2_act_2 =		(test_zone_2<<8)|$01
test_zone_2_act_3 =		(test_zone_2_2<<8)|$00
test_zone_2_act_4 =		(test_zone_2_2<<8)|$01
test_zone_3_act_1 =		(test_zone_3<<8)|$00
test_zone_3_act_2 =		(test_zone_3<<8)|$01
test_zone_3_act_3 =		(test_zone_3_2<<8)|$00
test_zone_3_act_4 =		(test_zone_3_2<<8)|$01
test_zone_4_act_1 =		(test_zone_4<<8)|$00
test_zone_4_act_2 =		(test_zone_4<<8)|$01
test_zone_4_act_3 =		(test_zone_4_2<<8)|$00
test_zone_4_act_4 =		(test_zone_4_2<<8)|$01
test_zone_5_act_1 =		(test_zone_5<<8)|$00
test_zone_5_act_2 =		(test_zone_5<<8)|$01
test_zone_5_act_3 =		(test_zone_5_2<<8)|$00
test_zone_5_act_4 =		(test_zone_5_2<<8)|$01
	endif
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
dummy_zone_act_1 =		(dummy_zone<<8)|$00
dummy_zone_act_2 =		(dummy_zone<<8)|$01
...
; -UNSPECIFIED Added a New Checksum Error screen Gamemode -GDMC5
GameModeID_ChecksumErrorScreen =	id(GameMode_ChecksumErrorScreen) ; 2C
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
GameModeID_DevMenu =	id(GameMode_DevMenu) ; 30
	endif
; -UNSPECIFIED Added a Dummy Menu Screen -GDMC5
GameModeID_DummyScreen =	id(GameMode_DummyScreen) ; 34
...
; -UNSPECIFIED Removed a Unused Leftover Palette -GDMC5
PalID_BGND =	id(PalPtr_BGND) ; 2
PalID_EHZ =	id(PalPtr_EHZ) ; 3
;PalID_DZ2 =	id(PalPtr_DZ2) ; 4
PalID_WZ =	id(PalPtr_WZ) ; 5
;PalID_DZ3 =	id(PalPtr_DZ3) ; 6
...
;PalID_MTZ3 =	id(PalPtr_MTZ3) ; C
PalID_OOZ =	id(PalPtr_OOZ) ; D
PalID_MCZ =	id(PalPtr_MCZ) ; E
PalID_CNZ =	id(PalPtr_CNZ) ; F
PalID_CPZ =	id(PalPtr_CPZ) ; 10
PalID_DEZ =	id(PalPtr_DEZ) ; 11
PalID_ARZ =	id(PalPtr_ARZ) ; 12
PalID_SCZ =	id(PalPtr_SCZ) ; 13
; -UNSPECIFIED Added Extra Zones -GDMC5
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
PalID_TZ1 =	id(PalPtr_TZ1) ; 14
	endif
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
PalID_DZ =	id(PalPtr_DZ) ; 15
...
; -UNSPECIFIED Added in Extra Special Stage Palettes -GDMC5
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
PalID_SST1 =	id(PalPtr_SST1) ; 23
PalID_SST2 =	id(PalPtr_SST2) ; 24
PalID_SST3 =	id(PalPtr_SST3) ; 25
PalID_SST4 =	id(PalPtr_SST4) ; 26
PalID_SST5 =	id(PalPtr_SST5) ; 27
	endif
PalID_SSPH =	id(PalPtr_SSPH) ; 28
PalID_SS1_2p =	id(PalPtr_SS1_2p) ; 29
PalID_SS2_2p =	id(PalPtr_SS2_2p) ; 2A
PalID_SS3_2p =	id(PalPtr_SS3_2p) ; 2B
PalID_OOZ_B =	id(PalPtr_OOZ_B) ; 2C
PalID_Menu =	id(PalPtr_Menu) ; 2D
PalID_Result =	id(PalPtr_Result) ; 2E
; -UNSPECIFIED Added a New Checksum Error screen Gamemode -GDMC5
PalID_ChecksumErrorScreen =	id(PalPtr_ChecksumErrorScreen) ; 2F
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
PalID_DevMenu =	id(PalPtr_DevMenu) ; 30
	endif
...
; -UNSPECIFIED Moved Tails Life Icon Plcptrs And Added New Plcptrs In Place of Them -GDMC5
PLCID_Unused1 =		id(PLCptr_Unused1) ; 6
PLCID_Unused2 =		id(PLCptr_Unused2) ; 7
; -UNSPECIFIED Added in Wood Zone -GDMC5
PLCID_Wz1 =		id(PLCptr_Wz1) ; 8
PLCID_Wz2 =		id(PLCptr_Wz2) ; 9
PLCID_Unused5 =		id(PLCptr_Unused5) ; A
PLCID_Unused6 =		id(PLCptr_Unused6) ; B
...
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
PLCID_Unused7 =		id(PLCptr_Unused7) ; 16
PLCID_Unused8 =		id(PLCptr_Unused8) ; 17
...
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
PLCID_Tz11 =		id(PLCptr_Tz11) ; 26
PLCID_Tz12 =		id(PLCptr_Tz12) ; 27
	endif
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
PLCID_Dz1 =		id(PLCptr_Dz1) ; 28
PLCID_Dz2 =		id(PLCptr_Dz2) ; 29
...
; -DEV Added In Special Dev Features -GDMC5
	if devMode=1
PLCID_Tz1Animals =	id(PLCptr_Tz1Animals) ; 3C
	endif
; -UNSPECIFIED Added in a Placeholder/Dummy Zone -GDMC5
PLCID_DzAnimals =	id(PLCptr_DzAnimals) ; 3D
PLCID_SpecialStage =	id(PLCptr_SpecialStage) ; 3E
PLCID_SpecStageBombs =	id(PLCptr_SpecStageBombs) ; 3F
PLCID_WfzBoss =		id(PLCptr_WfzBoss) ; 40
PLCID_Tornado =		id(PLCptr_Tornado) ; 41
PLCID_Capsule =		id(PLCptr_Capsule) ; 42
PLCID_Explosion =	id(PLCptr_Explosion) ; 43
PLCID_ResultsTails =	id(PLCptr_ResultsTails) ; 44
; -UNSPECIFIED Moved Tails Life Icon Plcptrs And Added New Plcptrs In Place of Them -GDMC5
PLCID_Miles1up =	id(PLCptr_Miles1up) ; 45
PLCID_MilesLife =	id(PLCptr_MilesLife) ; 46
PLCID_Tails1up =	id(PLCptr_Tails1up) ; 47
PLCID_TailsLife =	id(PLCptr_TailsLife) ; 48
; -UNSPECIFIED Added in a Full Death Egg Zone -GDMC5
PLCID_SilverSonicBoss =		id(PLCptr_SilverSonicBoss) ; 49
...
ObjID_SlopedCollapsPform =		id(ObjPtr_SlopedCollapsPform)	; 1A
...
ObjID_Bubbles =		id(ObjPtr_Bubbles)		; 24
...
; -UNSPECIFIED Added in Hidden Palace Zone -GDMC5
...
; -UNSPECIFIED Added in Hidden Palace Zone -GDMC5
ObjID_BBat =			id(ObjPtr_BBat)		; 4C
ObjID_Stegway =			id(ObjPtr_Stegway)		; 4D
ObjID_Gator =			id(ObjPtr_Gator)		; 4E
...
ObjID_ConveyorBelt =		id(ObjPtr_ConveyorBelt)	; 72
...
; -UNSPECIFIED Added in Hidden Palace Zone -GDMC5
ObjID_BFish =			id(ObjPtr_BFish)		; DD
; -UNSPECIFIED Added in a Template Object -GDMC5
ObjID_Template =			id(ObjPtr_Template)		; DE
; -UNSPECIFIED Added in some placeholder Null Objects -GDMC5
ObjID_PlaceholderObj1 =			id(ObjPtr_PlaceholderObj1)		; DF
ObjID_PlaceholderObj2 =			id(ObjPtr_PlaceholderObj2)		; E0
ObjID_PlaceholderObj3 =			id(ObjPtr_PlaceholderObj3)		; E1
ObjID_PlaceholderObj4 =			id(ObjPtr_PlaceholderObj4)		; E2
ObjID_PlaceholderObj5 =			id(ObjPtr_PlaceholderObj5)		; E3
ObjID_PlaceholderObj6 =			id(ObjPtr_PlaceholderObj6)		; E4
; -UNSPECIFIED Added in a KIS2 ported Knuckles Object! -GDMC5
ObjID_Knuckles =			id(ObjPtr_Knuckles)		; E5
...
; -UNSPECIFIED Restored the burned death animation -GDMC5
AniIDSonAni_Burned		= id(SonAni_Burned_ptr)	; 22 ; $16
...
Reserved_Object_RAM:
MainCharacter:			; first object (usually Sonic except in a Tails Alone game and Knuckles Alone game)
				ds.b	object_size
Sidekick:			; second object (Tails in a Sonic and Tails game and Knuckles and Tails game)
				ds.b	object_size
TitleCard:
...
Scroll_lock_P2:			ds.b	1	; set to 1 to stop all scrolling for P2
	; -UNSPECIFIED Removed unk_EEC0 Variable -GDMC5
				ds.l	1	; unused
	; -UNSPECIFIED Removed unk_EEC4 Variable -GDMC5
				ds.w	1	; unused
...
; -UNSPECIFIED Removed Maybe Unused S1_hidden_credits_flag Flag -GDMC5
				ds.b	1	; seems unused, This NEEDs to be after Debug_options_flag because of the call to CheckCheats
...
Player_mode:			ds.w	1	; 0 = Sonic and Tails, 1 = Sonic, 2 = Tails, 3 = Knuckles, 4 = Knuckles and Tails, 5 = Blue Knuckles
Player_option:			ds.w	1	; 0 = Sonic and Tails, 1 = Sonic, 2 = Tails, 3 = Knuckles, 4 = Knuckles and Tails, 5 = Blue Knuckles
...
; -UNSPECIFIED Added a Extra Secret Chaos Emerald -GDMC5
Got_Emeralds_array:		ds.b	9	; (9 bytes)
				ds.b	5	; $FFFFFFBB-$FFFFFFBF ; filler
...
; -UNSPECIFIED Removed The Unused Leftover Ending demo Code -GDMC5
; -UNSPECIFIED Moved a Unused Variable -GDMC5
				ds.w	1
...
; -UNSPECIFIED Removed unk_FFDA to unk_FFDF -GDMC5
; -UNSPECIFIED Added S3 Complete's Super transformation tweaks -GDMC5
Last_jump_press		ds.b	1
				ds.b	1
; -UNSPECIFIED Added in a Cutscene mode Flag -GDMC5
Cutscene_mode	ds.b	1
				ds.b	1
...
; -UNSPECIFIED Added in some Ported KIS2 Features for Knuckles -GDMC5
; KiS2: These were moved to make room for the below variables.
;Demo_mode_flag:			ds.w	1 ; 1 if a demo is playing (2 bytes)
;Demo_number:			ds.w	1 ; which demo will play next (2 bytes)
; -UNSPECIFIED Removed The Unused Leftover Ending demo Code -GDMC5
; -UNSPECIFIED Moved a Unused Variable -GDMC5
...
; -DEV Added In Special Dev Features -GDMC5
Dev_mode_flag:		ds.b	1	; a special developer flag for debugging in this hack (1 bytes)
				ds.b	1	; unused
Dev_menu_option:		ds.w	1	; this is for the currently selected option in the dev menus (2 bytes)
Dev_menu_Two_player_mode:		ds.w	1	; flag (0 for main game) (2 bytes)
Dev_menu_Game_Mode:			ds.b	1	; see GameModesArray (master level trigger, Mstr_Lvl_Trigger) (1 bytes)
Dev_menu_Zone:			ds.b	1	; (1 bytes)
Dev_menu_Act:			ds.b	1	; (1 bytes)
Dev_menu_Zone_2P:			ds.b	1	; (1 bytes)
Dev_menu_Act_2P:			ds.b	1	; (1 bytes)
Dev_menu_Special_Stage:		ds.b	1	; (1 bytes)
Dev_menu_Life_count:			ds.b	1	; (1 bytes)
Dev_menu_Life_count_2P:			ds.b	1	; (1 bytes)
Dev_menu_Continue_count:			ds.b	1	; (1 bytes)
Dev_menu_Emerald_count:			ds.b	1	; (1 bytes)
Dev_menu_Results_Screen_2P:		ds.w	1	; 0 = act, 1 = zone, 2 = game, 3 = SS, 4 = SS all (2 bytes)
Dev_menu_Demo_number:			ds.w	1 ; which demo will play next (2 bytes)
				ds.b	$4	; unused
; -UNSPECIFIED Moved a Unused Variable -GDMC5
				ds.w	1 ; unused
				ds.w	1 ; unused
...
; RAM variables - Continue screen
	phase	Object_RAM	; Move back to the object RAM
				; These two object slots are presumably used by Sonic and Tails and Knuckles
				ds.b	object_size
				ds.b	object_size
...
ArtTile_ArtNem_HPZ_Unknown_Platform   = $0384
ArtTile_ArtNem_HPZ_Emerald            = $0392
ArtTile_ArtNem_BreakWall              = $043C
ArtTile_ArtNem_Stegway               = $03BA
ArtTile_ArtNem_Redz                   = $0500
ArtTile_ArtNem_BBat                 = $0530
ArtTile_ArtNem_Gator               = $0560
;ArtTile_ArtNem_BFish                = $0530
