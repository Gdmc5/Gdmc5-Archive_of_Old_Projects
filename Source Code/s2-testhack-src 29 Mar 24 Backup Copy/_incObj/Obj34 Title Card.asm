...
Obj34_ActNumber:	; the act number, coming in
	...
	cmpi.b	#hidden_palace_zone,d0	; is it Hidden Palace Zone?
	beq.s	BranchTo9_DeleteObject	; if yes, branch
	; -UNSPECIFIED Added in Cyber City Zone -GDMC5
	cmpi.b	#cyber_city_zone,d0	; is it Cyber City Zone?
	beq.s	BranchTo9_DeleteObject	; if yes, branch
	...
	beq.s	Obj34_ActNumber_Act3			; if not, branch
	cmpi.b	#death_egg_zone,d0	; is it Death Egg Zone?
	bne.s	+	; if no, branch
Obj34_ActNumber_Act3:
	; -UNSPECIFIED Added Extra Zones -GDMC5
	moveq	#NumberOfZones+4,d1	; Act number mappings (Act 3).  Used for drawing MTZ Act 3,s And DEZ Act 3,s titlecard only
+
