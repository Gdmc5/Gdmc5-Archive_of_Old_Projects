...
Obj02:
	...
	; -UNSPECIFIED Added Tails Support For Debug Mode -GDMC5
...
Obj02_Init_Continued:
	...
	; -BUGFIXES Fixed a Bug With the Tails Object Not Clearing The Super Flag. Credit Goes to DankRank For the Fix -GDMC5
...
Obj02_CheckGameOver_2Pmode:
	...
	cmpi.b	#100,(Life_count_2P).w	; does the player 2 have infinite lives
	beq.s	Obj02_ResetLevel	; if yes branch
...
TailsAniData:		offsetTable
			...
			offsetTableEntry.w TailsAni_Burned	; 22 ; $16
